...
echo "Execute command: napls2_mmn_fit_dcm_to_individuals(${SGE_TASK_ID})" 
matlab -nodisplay -nodesktop -nojvm -nosplash -singleCompThread -r "napls2_mmn_fit_dcm_to_individuals(${SGE_TASK_ID})" 
