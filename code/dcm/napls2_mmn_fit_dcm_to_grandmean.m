...
function napls2_mmn_fit_dcm_to_grandmean(subj)
...
pmean = fullfile(pmain,'grand_mean');
presults = fullfile(pmain,'dcm_ei',['mmn_grandmean_all_v' num2str(version)]);
fep = fullfile(pmain,'dcm_ei','priors','dcm_mmn_grandmean_hc_cmc_ei_v1_vbsv898.mat');
...
%% Run
file = dir(fullfile(pmean,'mmn_grandmean_all.mat'));
